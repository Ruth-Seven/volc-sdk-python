...
import volcengine.const.Const as Const
import volcengine.Policy as Policy
import volcengine.util.Util as Util
from volcengine.ApiInfo import ApiInfo
from volcengine.base.Service import json as json
...
service_info_map = {
    Const.REGION_CN_NORTH1: ServiceInfo(
        "imagex.volcengineapi.com",
        {"Accept": "application/json"},
        Credentials("", "", IMAGEX_SERVICE_NAME, Const.REGION_CN_NORTH1),
        10,
        10,
        "https",
    ),
    Const.REGION_AP_SINGAPORE1: ServiceInfo(
        "imagex-ap-singapore-1.volcengineapi.com",
        {"Accept": "application/json"},
        Credentials("", "", IMAGEX_SERVICE_NAME, Const.REGION_AP_SINGAPORE1),
        10,
        10,
        "https",
    ),
    Const.REGION_US_EAST1: ServiceInfo(
        "imagex-us-east-1.volcengineapi.com",
        {"Accept": "application/json"},
        Credentials("", "", IMAGEX_SERVICE_NAME, Const.REGION_US_EAST1),
        10,
        10,
        "https",
    ),
...
api_info = {
    # 模板管理
    "CreateImageTemplate": ApiInfo(
        "POST",
        "/",
        {"Action": "CreateImageTemplate", "Version": IMAGEX_API_VERSION},
        {},
        {},
    ),
    "DeleteImageTemplate": ApiInfo(
        "POST",
        "/",
        {"Action": "DeleteImageTemplate", "Version": IMAGEX_API_VERSION},
        {},
        {},
    ),
    "PreviewImageTemplate": ApiInfo(
        "POST",
        "/",
        {"Action": "PreviewImageTemplate", "Version": IMAGEX_API_VERSION},
        {},
        {},
    ),
    "GetImageTemplate": ApiInfo(
        "GET",
        "/",
        {"Action": "GetImageTemplate", "Version": IMAGEX_API_VERSION},
        {},
        {},
    ),
    "GetAllImageTemplates": ApiInfo(
        "GET",
        "/",
        {"Action": "GetAllImageTemplates", "Version": IMAGEX_API_VERSION},
        {},
        {},
    ),
    # 资源管理相关
    "ApplyImageUpload": ApiInfo(
        "GET",
        "/",
        {"Action": "ApplyImageUpload", "Version": IMAGEX_API_VERSION},
        {},
        {},
    ),
    "CommitImageUpload": ApiInfo(
        "POST",
        "/",
        {"Action": "CommitImageUpload", "Version": IMAGEX_API_VERSION},
        {},
        {},
    ),
    "DeleteImageUploadFiles": ApiInfo(
        "POST",
        "/",
        {"Action": "DeleteImageUploadFiles", "Version": IMAGEX_API_VERSION},
        {},
        {},
    ),
    "UpdateImageUploadFiles": ApiInfo(
        "POST",
        "/",
        {"Action": "UpdateImageUploadFiles", "Version": IMAGEX_API_VERSION},
        {},
        {},
    ),
    "PreviewImageUploadFile": ApiInfo(
        "GET",
        "/",
        {"Action": "PreviewImageUploadFile", "Version": IMAGEX_API_VERSION},
        {},
        {},
    ),
    "GetImageUploadFile": ApiInfo(
        "GET",
        "/",
        {"Action": "GetImageUploadFile", "Version": IMAGEX_API_VERSION},
        {},
        {},
    ),
    "GetImageUploadFiles": ApiInfo(
        "GET",
        "/",
        {"Action": "GetImageUploadFiles", "Version": IMAGEX_API_VERSION},
        {},
        {},
    ),
    "GetImageUpdateFiles": ApiInfo(
        "GET",
        "/",
        {"Action": "GetImageUpdateFiles", "Version": IMAGEX_API_VERSION},
        {},
        {},
    ),
    "GetImageOCR": ApiInfo(
        "POST", "/", {"Action": "GetImageOCR", "Version": IMAGEX_API_VERSION}, {}, {}
    ),
}


class ImageXService(Service):
    def __init__(self, region=Const.REGION_CN_NORTH1):
    ...
    def do_upload(self, img_datas, host, store_infos):
        ...
        for d in img_datas:
            ...
            check_sum = Util.crc32(d) & 0xFFFFFFFF
            ...
            if not upload_status:
                raise Exception(f"upload {url} error {resp}")
            idx += 1
    ...
    def get_upload_auth_token(self, params):
        ...
        data = json.dumps(ret)
        if Util.sys.version_info[0] == 3:
            return Util.base64.b64encode(data.encode("utf-8")).decode("utf-8")
        else:
            return Util.base64.b64encode(data.decode("utf-8"))
    ...
    def get_upload_auth(self, service_ids, expire=60 * 60, key_ptn=""):
        ...
        inline_policy = Policy(
            [
                Service.Statement.new_allow_statement(
    ...
    def update_image_urls(self, service_id, urls, action=0):
        ...
        query = {"ServiceId": service_id}
        body = {"Action": action, "ImageUrls": urls}
