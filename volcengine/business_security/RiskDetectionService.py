...
class RiskDetectService(Service):
    ...
    def get_service_info():
        service_info = ServiceInfo(
            ...
            Credentials("", "", "BusinessSecurity", "cn-north-1"),
            5,
            5,
        )
        return service_info
    ...
    def get_api_info():
        api_info = {
            "RiskDetection": ApiInfo(
                "POST",
                "/",
                {"Action": "RiskDetection", "Version": "2021-02-02"},
                {},
                {},
            ),
            "AsyncRiskDetection": ApiInfo(
                "POST",
                "/",
                {"Action": "AsyncRiskDetection", "Version": "2021-02-25"},
                {},
                {},
            ),
            "RiskResult": ApiInfo(
                "GET", "/", {"Action": "RiskResult", "Version": "2021-03-10"}, {}, {}
            ),
        }
