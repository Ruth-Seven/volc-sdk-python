...
class VEditService(Service):
    ...
    def get_service_info(region):
        service_info_map = {
            "cn-north-1": ServiceInfo(
                "vedit.volcengineapi.com",
                {"Accept": "application/json"},
                Credentials("", "", "edit", "cn-north-1"),
                5,
                5,
                "https",
            )
    ...
    def get_api_info():
        api_info = {
            "SubmitDirectEditTaskAsync": ApiInfo(
                "POST",
                "/",
                {"Action": "SubmitDirectEditTaskAsync", "Version": "2018-01-01"},
                {},
                {},
            ),
            "GetDirectEditResult": ApiInfo(
                "POST",
                "/",
            ...
            "SubmitTemplateTaskAsync": ApiInfo(
                "POST",
                "/",
                {"Action": "SubmitTemplateTaskAsync", "Version": "2018-01-01"},
                {},
                {},
            ),
        }
