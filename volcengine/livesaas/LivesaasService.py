...
service_info_map = {
    Const.REGION_CN_NORTH1: ServiceInfo(
        ...
        Credentials("", "", LIVESAAS_SERVICE_NAME, Const.REGION_CN_NORTH1),
        5,
        5,
        "https",
    ),
...
api_info = {
    # 直播间管理类接口
    "CreateActivityAPI": ApiInfo(
        "POST",
        "/",
        {"Action": "CreateActivityAPI", "Version": LIVESAAS_API_VERSION},
        {},
        {},
    ),
    "DeleteActivityAPI": ApiInfo(
        "POST",
        "/",
        {"Action": "DeleteActivityAPI", "Version": LIVESAAS_API_VERSION},
        {},
        {},
    ),
    "ListActivityAPI": ApiInfo(
        "GET",
        "/",
        {"Action": "ListActivityAPI", "Version": LIVESAAS_API_VERSION},
        {},
        {},
    ),
    # 直播控制类接口
    "UpdateActivityStatusAPI": ApiInfo(
        "POST",
        "/",
        {"Action": "UpdateActivityStatusAPI", "Version": LIVESAAS_API_VERSION},
        {},
        {},
    ),
    "UpdatePullToPushAPI": ApiInfo(
        "POST",
        "/",
        {"Action": "UpdatePullToPushAPI", "Version": LIVESAAS_API_VERSION},
        {},
        {},
    ),
    "GetActivityAPI": ApiInfo(
        "GET",
        "/",
        {"Action": "GetActivityAPI", "Version": LIVESAAS_API_VERSION},
        {},
        {},
    ),
    "GetStreamsAPI": ApiInfo(
        "GET", "/", {"Action": "GetStreamsAPI", "Version": LIVESAAS_API_VERSION}, {}, {}
    ),
    "UpdateActivityBasicConfigAPI": ApiInfo(
        "POST",
        "/",
        {"Action": "UpdateActivityBasicConfigAPI", "Version": LIVESAAS_API_VERSION},
        {},
        {},
    ),
    "GetActivityBasicConfigAPI": ApiInfo(
        "GET",
        "/",
        {"Action": "GetActivityBasicConfigAPI", "Version": LIVESAAS_API_VERSION},
        {},
        {},
    ),
    "UpdateLoopVideoAPI": ApiInfo(
        "POST",
        "/",
        {"Action": "UpdateLoopVideoAPI", "Version": LIVESAAS_API_VERSION},
        {},
        {},
    ),
    "UpdateLoopVideoStatusAPI": ApiInfo(
        "POST",
        "/",
        {"Action": "UpdateLoopVideoStatusAPI", "Version": LIVESAAS_API_VERSION},
        {},
        {},
    ),
    # 回放管理类接口
    "UploadReplayAPI": ApiInfo(
        "POST",
        "/",
        {"Action": "UploadReplayAPI", "Version": LIVESAAS_API_VERSION},
        {},
        {},
    ),
    "UpdateMediaOnlineStatusAPI": ApiInfo(
        "POST",
        "/",
        {"Action": "UpdateMediaOnlineStatusAPI", "Version": LIVESAAS_API_VERSION},
        {},
        {},
    ),
    "ListMediasAPI": ApiInfo(
        "GET", "/", {"Action": "ListMediasAPI", "Version": LIVESAAS_API_VERSION}, {}, {}
    ),
    # 评论类接口
    "PresenterChatAPI": ApiInfo(
        "POST",
        "/",
        {"Action": "PresenterChatAPI", "Version": LIVESAAS_API_VERSION},
        {},
        {},
    ),
    "DeleteChatAPI": ApiInfo(
        "POST",
        "/",
        {"Action": "DeleteChatAPI", "Version": LIVESAAS_API_VERSION},
        {},
        {},
    ),
    # 客户端SDK类接口
    "GetSDKTokenAPI": ApiInfo(
        "POST",
        "/",
        {"Action": "GetSDKTokenAPI", "Version": LIVESAAS_API_VERSION},
        {},
        {},
    ),
}
...
class LivesaasService(Service):
    ...
    async def async_update_activity_basic_config_api(self, body):
        res = await self.async_json(
            "UpdateActivityBasicConfigAPI", dict(), json.dumps(body)
        )
        if res == "":
            raise Exception("UpdateActivityBasicConfigAPI: empty response")
        res_json = json.loads(res)
    ...
    async def async_update_loop_video_status_api(self, body):
        res = await self.async_json(
            "UpdateLoopVideoStatusAPI", dict(), json.dumps(body)
        )
        if res == "":
            raise Exception("UpdateLoopVideoStatusAPI: empty response")
        res_json = json.loads(res)
    ...
    async def async_update_media_online_status_api(self, body):
        res = await self.async_json(
            "UpdateMediaOnlineStatusAPI", dict(), json.dumps(body)
        )
        if res == "":
            raise Exception("UpdateMediaOnlineStatusAPI: empty response")
        res_json = json.loads(res)
